...
<body>
	<div class="body">
        <div class="header_body">
            ...
            <div class="na_v">
                <ul>
                    ...
                    <li><a class="bgcolor-11" href="photo.php" target="_blank">相册</a></li>
        ...
        <div class="main clearfix">
            <div class="main-left">
                <div class="main-page">
                    当前位置：&nbsp;<a href="">首页</a>&nbsp;>&nbsp;<a href="">相册</a>
                </div>
                <div class="left-art">
                    <ul class="photo-body">
                    	<!--循环体开始-->
                        <? 
							$sql="select * from `my_photo` where `addname`='qcx233666' ";
							$result=mysql_query($sql);
							while($result_arr=mysql_fetch_array($result)){
						?>
                    	<li><img src="<? echo $result_arr["photo_address"]?>" alt="" /></li>
                        <? } ?>
                        <!--循环体结束-->
                    </ul>
                </div>
                    ...
                    <div class="tuijian-con">
                        <ul>
                            ...
                            <?
								...
								/*$result_arr_art_l=mysql_fetch_array($result_art_list_n);
								echo $result_arr_art_l[0];*/
